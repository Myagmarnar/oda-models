...
type BundledGroupProductOfferingOptionMvo struct {
	...
	NumberRelOfferLowerLimit int32 `json:"numberRelOfferLowerLimit"`
	...
	NumberRelOfferUpperLimit int32 `json:"numberRelOfferUpperLimit"`
