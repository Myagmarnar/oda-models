...
type ProductOffering struct {
	...
	ProductOfferingCharacteristic []CharacteristicSpecification `json:"productOfferingCharacteristic,omitempty"`
	...
	AllowedAction []AllowedProductAction `json:"allowedAction,omitempty"`
