...
type CategoryMvo struct {
	// Description of the category
	Description string `json:"description,omitempty"`
	// If true, this Boolean indicates that the category is a root of categories
	IsRoot bool `json:"isRoot,omitempty"`

	Parent *CategoryRefMvo `json:"parent,omitempty"`
	// List of product offerings that are referred to by the category
	ProductOffering []ProductOfferingRefMvo `json:"productOffering,omitempty"`
	...
	SubCategory []CategoryRefMvo `json:"subCategory,omitempty"`
