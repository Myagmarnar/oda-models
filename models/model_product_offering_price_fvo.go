...
type ProductOfferingPriceFvo struct {
	...
	BundledPopRelationship []BundledProductOfferingPriceRelationshipFvo `json:"bundledPopRelationship,omitempty"`
	...
	PopRelationship []ProductOfferingPriceRelationshipFvo `json:"popRelationship,omitempty"`
	...
	PricingLogicAlgorithm []PricingLogicAlgorithmFvo `json:"pricingLogicAlgorithm,omitempty"`
	// An amount of money levied on the price of a Product by a legislative body.
	Tax []TaxItemFvo `json:"tax,omitempty"`
