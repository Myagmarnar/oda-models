...
type ProductSpecificationMvo struct {
	...
	ProductSpecCharacteristic []CharacteristicSpecificationMvo `json:"productSpecCharacteristic,omitempty"`
	// ServiceSpecification(s) required to realize a ProductSpecification.
	ServiceSpecification []ServiceSpecificationRefMvo `json:"serviceSpecification,omitempty"`
	// A type of ProductSpecification that belongs to a grouping of ProductSpecifications made available to the market. It inherits of all attributes of ProductSpecification.
	BundledProductSpecification []BundledProductSpecificationMvo `json:"bundledProductSpecification,omitempty"`
	// A migration, substitution, dependency or exclusivity relationship between/among product specifications.
	ProductSpecificationRelationship []ProductSpecificationRelationshipMvo `json:"productSpecificationRelationship,omitempty"`
	// The ResourceSpecification is required to realize a ProductSpecification.
	ResourceSpecification []ResourceSpecificationRefMvo `json:"resourceSpecification,omitempty"`
	...
	IntentSpecification *IntentSpecificationRefMvo `json:"intentSpecification,omitempty"`
