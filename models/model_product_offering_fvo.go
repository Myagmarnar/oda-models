...
type ProductOfferingFvo struct {
	...
	Place []PlaceRefFvo `json:"place,omitempty"`

	ServiceLevelAgreement *SlaRefFvo `json:"serviceLevelAgreement,omitempty"`
	// The channel defines the channel for selling product offerings.
	Channel []ChannelRefFvo `json:"channel,omitempty"`

	ServiceCandidate *ServiceCandidateRefFvo `json:"serviceCandidate,omitempty"`
	// The category resource is used to group product offerings, service and resource candidates in logical containers. Categories can contain other categories and/or product offerings, resource or service candidates.
	Category []CategoryRefFvo `json:"category,omitempty"`

	ResourceCandidate *ResourceCandidateRefFvo `json:"resourceCandidate,omitempty"`
	// A condition under which a ProductOffering is made available to Customers. For instance, a productOffering can be offered with multiple commitment periods.
	ProductOfferingTerm []ProductOfferingTermFvo `json:"productOfferingTerm,omitempty"`
	...
	ProductOfferingPrice []ProductOfferingPriceRefOrValueFvo `json:"productOfferingPrice,omitempty"`
	...
	MarketSegment []MarketSegmentRefFvo `json:"marketSegment,omitempty"`
	// A relationship between this product offering and other product offerings.
	ProductOfferingRelationship []ProductOfferingRelationshipFvo `json:"productOfferingRelationship,omitempty"`
	...
	ProductOfferingCharacteristic []CharacteristicSpecificationFvo `json:"productOfferingCharacteristic,omitempty"`
	...
	ProdSpecCharValueUse []ProductSpecificationCharacteristicValueUseFvo `json:"prodSpecCharValueUse,omitempty"`
	...
	AllowedAction []AllowedProductActionFvo `json:"allowedAction,omitempty"`
