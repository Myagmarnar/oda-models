...
type ProductSpecificationCharacteristicValueUseMvo struct {
	...
	ProductSpecCharacteristicValue []CharacteristicValueSpecificationMvo `json:"productSpecCharacteristicValue,omitempty"`
